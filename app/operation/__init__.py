# This file is now called "Operation.py", and it contains a class `Operation` with four static methods:
# addition, subtraction, multiplication, and division.
# These methods are encapsulated within the `Operation` class, providing a structured way to perform basic math on two numbers.
# When we need to add, subtract, multiply, or divide numbers, we can call these static methods through the class.

class Operation:
    """
    The Operation class serves as a container for basic math operations.
    ...
    def addition(a: float, b: float) -> float:
        ...
        Example: if we call Operation.addition(5.0, 3.0), it will return 8.0.
        """
    ...
    def subtraction(a: float, b: float) -> float:
        ...
        Example: if we call Operation.subtraction(10.0, 4.0), it will return 6.0.
        """
    ...
    def multiplication(a: float, b: float) -> float:
        ...
        Example: if we call Operation.multiplication(2.0, 3.0), it will return 6.0.
        """
    ...
    def division(a: float, b: float) -> float:
        ...
        Example: if we call Operation.division(10.0, 2.0), it will return 5.0.
        But if we call Operation.division(10.0, 0.0), it will raise a ValueError and say "Division by zero is not allowed."
        """
        if b == 0:
